...
<body>
	<div>
		...
		<div class="loginside">
				<form action="searchVehicle" id="loginForm">
					<table  class="logTable" align="center">
						<tr>
							<td colspan="2" align="center" >Enter Vehicle Registration No.</td>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="text" name="regNo" id="regNo" required /></td>
						</tr>
