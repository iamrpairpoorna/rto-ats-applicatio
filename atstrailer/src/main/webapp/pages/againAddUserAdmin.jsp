			...
			<table class="logTable" align="center" border="2">
				...
				<tr>
					...
					<td><input type="text" name="firstName" id="firstName"
						value="${person.firstName}" required /> <span class=".errorData"
						id="fname_span">${error_fname}</span></td>

				</tr>
				<tr>
					<td>Last Name:</td>
					<td><input type="text" name="lastName" id="lastName"
						value="${person.lastName}" required /> <span class=".errorData"
						id="lname_span">${error_lname}</span></td>

				</tr>
				<tr>
					<td>Email:</td>
					<td><input type="email" name="userEmail" id="userEmail"
						value="" required /> <span class=".errorData" id="email_span">${error_email}</span></td>

				</tr>
				<tr>
					<td>Phone Number:</td>
					<td><input type="text" name="userPhone" id="userPhone"
						value="${person.userPhone}" required /> <span class=".errorData"
						id="phone_span">${error_phone}</span></td>
				...
				<tr>
					...
					<td><input type="radio" name="userGender" value="male"
						...
						name="userGender" value="female" id="userGender" required>Female
